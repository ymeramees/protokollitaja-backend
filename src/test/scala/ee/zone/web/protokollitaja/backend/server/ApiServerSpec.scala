...
//import ee.zone.web.protokollitaja.backend.entities.{Competition, CompetitionHeader, Competitor, Event, EventHeader}
...
//    eventCompetitors = List(Competitor("324", "Paavel", "Pakiraam", "2019", "SharpshootersClub", List(), Some(List()), "0,0", "0", "Fin", ""))
//  )
//
...
//      request ~> route ~> check {
//        status shouldBe StatusCodes.OK
//        responseAs[String] shouldEqual "[{\"id\":\"324\",\"firstName\":\"Paavel\",\"lastName\":\"Pakiraam\",\"birthYear\":\"\",\"club\":\"SharpshootersClub\",\"subtotals\":[],\"series\":[],\"totalResult\":\"0,0\",\"innerTens\":\"0\",\"finals\":\"Fin\",\"remarks\":\"\"}]"
//      }
//    }
//
